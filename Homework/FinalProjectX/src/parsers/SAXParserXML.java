 ...
 */
    ...
    /*
     Парсер SAX, предназначенный для парсинга файлов формата XML, содержит несколько ArrayList, также осуществляет обработку и вывод
    информации, при сериализации обращается к модели Students, содержит private поля для манипуляции данными
    */
